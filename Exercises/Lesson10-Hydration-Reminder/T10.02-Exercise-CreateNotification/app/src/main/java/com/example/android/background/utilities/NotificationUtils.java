...
public class NotificationUtils {
    private static final int WATER_REMINDER_INTENT_ID = 100;
    ...
    public static PendingIntent contentIntent(Context c) {
        // TODO (2) Create an intent that opens up the MainActivity
        Intent intent = new Intent(c, MainActivity.class);
        // TODO (3) Create a PendingIntent using getActivity that:
        return PendingIntent.getActivity(c, WATER_REMINDER_INTENT_ID, intent, PendingIntent.FLAG_UPDATE_CURRENT);
    ...
    private static Bitmap largeIcon(Context c) {

...
//        should put this in a method call, to avoid duplication
        setPrefColor(sharedPreferences);
        // Register the listener
        sharedPreferences.registerOnSharedPreferenceChangeListener(this);
    }
    public void setPrefColor(SharedPreferences sharedPreferences){
        mVisualizerView.setColor(sharedPreferences.getString(getString(R.string.pref_color_choice_key), getString(R.string.pref_color_red_value)));
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
        ...
        } else if (key.equals(getString(R.string.pref_color_choice_key)))
            setPrefColor(sharedPreferences);
    }

...
public class VisualizerActivity extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
        if (key.equals(getString(R.string.pref_show_bass_key))) {
            ...
            boolean defaultVal = getResources().getBoolean(R.bool.pref_show_bass_default);
            mVisualizerView.setShowBass(sharedPreferences.getBoolean(key, defaultVal));
        }
    }
    ...
    public Action getIndexApiAction() {
        Thing object = new Thing.Builder()
                .setName("Visualizer Page") // TODO: Define a title for the content shown.

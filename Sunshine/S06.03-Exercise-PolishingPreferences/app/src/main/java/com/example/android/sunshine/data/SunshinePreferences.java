...
public class SunshinePreferences {
    ...
    public static String getPreferredWeatherLocation(Context context) {
        ...
        return sp.getString(context.getString(R.string.pref_location_key), getDefaultWeatherLocation());
    }
    ...
    public static boolean isMetric(Context context) {
        ...
        return false;//sp.getString(key, "").equals(context.getString(R.string.pref_units_label_metric));
    }
